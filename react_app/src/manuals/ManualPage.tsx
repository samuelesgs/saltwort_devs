    ...
    return (
        <div className="flex flex-col w-full overflow-hidden p-3">
            <div className="w-full">
                <div
                    className="bg-[#1F7EB7] text-white rounded-xl p-2 m-4 h-full">
                    <p
                        key={current}
                ...
                <Carousel
                    ...
                    <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-4">
                        <CarouselPrevious
                            className="static h-10 w-10 -translate-x-35 translate-y-0 bg-[#1F7EB7] text-white hover:text-white border border-transparent"
                        />
